...
Título: Sistema de Gestión de Tareas (Con algunas funciones usadas en ITIL).

Tecnologías: Spring MVC, Java, Thymeleaf, Bootstrap 5, Aspectos (AOP).

Funcionalidades Clave:

Gestión de estados de tareas (Abierto, En Proceso, Escalado, etc.).

Seguimiento de SLA mediante alertas visuales.

Registro de actividad mediante Programación Orientada a Aspectos.

Configuración robusta mediante XML.
